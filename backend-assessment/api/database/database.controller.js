...
module.exports = {
    ...
    show: async (req, res) => {
        const { success, message, data } = await caseStudyService.getOne(
            req.params.id
        );
    ...
    showTable: async (req, res) => {
        const { success, message, data } = await caseStudyService.getOneDetail(
            req.params.id,
    ...
    store: async (req, res) => {
        const { success, message, data } = await caseStudyService.insert(
            req.body,
            req.user
        );
    ...
    upload: async (req, res) => {
        ...
        caseStudyService
            .insertSQL(req.params.id, req.body, req.user, req.file)
    ...
    destroy: async (req, res) => {
        const { success, message, data } = await caseStudyService.deleteOne(
            req.params.id
        );
