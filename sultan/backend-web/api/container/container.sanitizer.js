...
const checkQuestionIds = body("questions", "cannot null").notEmpty().bail().isArray().withMessage("must be array");
const checkQuestionId = param("question_id", "cannot null").notEmpty().bail().isInt().withMessage("must be number");
