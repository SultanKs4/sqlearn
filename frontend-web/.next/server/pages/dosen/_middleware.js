...
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[9484],{
...
/* harmony default export */ __webpack_exports__["default"] = ((0,next_auth_middleware__WEBPACK_IMPORTED_MODULE_0__.withAuth)({
  callbacks: {
    authorized: ({
      ...
      return (token === null || token === void 0 ? void 0 : token.userRole) === "dosen";
    }
  }
}));
...
/* harmony import */ var next_dist_server_web_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(84384);
        ...
        var mod = __webpack_require__(62362)
        var handler = mod.middleware || mod.default;

        if (typeof handler !== 'function') {
          throw new Error('The Middleware "pages/dosen/_middleware" must export a `middleware` or a `default` function');
        }
...
/******/ __webpack_require__.O(0, [726], function() { return __webpack_exec__(3321); });
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ (_ENTRIES = typeof _ENTRIES === "undefined" ? {} : _ENTRIES)["middleware_pages/dosen/_middleware"] = __webpack_exports__;
/******/ }
]);